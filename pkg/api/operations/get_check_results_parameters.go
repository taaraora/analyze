...
// NewGetCheckResultsParams creates a new GetCheckResultsParams object
// no default values defined in spec.
func NewGetCheckResultsParams() GetCheckResultsParams {

	return GetCheckResultsParams{}
}

// GetCheckResultsParams contains all the bound params for the get check results operation
