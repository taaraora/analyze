...
func (o *GetPluginURL) Build() (*url.URL, error) {
	...
	if pluginID != "" {
		...
		return nil, errors.New("pluginId is required on GetPluginURL")
	}
...
func (o *GetPluginURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPluginURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPluginURL")
	}
